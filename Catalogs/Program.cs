...
builder.Services.AddScoped<IEntityRepository<CatalogDataModel>, EntityRepository<CatalogDataModel>>();
builder.Services.AddScoped<IEntityRepository<CatalogModel>, EntityRepository<CatalogModel>>();
